...
class ParallelRunner:
    ...
    def __init__(self, args, logger):
        ...
        self.pos_flag = getattr(self.args, "pos_flag", False)
    ...
    def reset(self):
        ...
        for parent_conn in self.parent_conns:
            ...
            if self.pos_flag:
                pre_transition_data["positions"].append(data["positions"])
    ...
    def run(self, test_mode=False):
        ...
        while True:
            ...
            for idx, parent_conn in enumerate(self.parent_conns):
                if not terminated[idx]:
                    ...
                    episode_returns[idx] += mean(data["reward"])
        ...
        # if test_mode and (len(self.test_returns_red) == n_test_runs):
            ...
            remote.send(
                {
                    ...
                    "state": state,
                    "positions": env.get_positions(),  # added for position
